...
public class VolunteerScanQRResolveActivity extends BaseAppCompatActivity implements
        ZXingScannerView.ResultHandler {
private Context context;
private LoginResponse loginResponse;
private RelativeLayout backLayout;
private Button resolve,notattend;
    private VolunteerScanQRResolveActivity activity;
    private GenericResponse genericResponse;
    private int claimId;
    private String type,serviceNm,claimList;

    String pay_num = "";
    private String qrcodeNumber,zone,serviceTag;
private TextView headerTV,selectedExhibitorTv,serviceNameTv,statusTv,commentTv,qrcodeTv,zoneTv,claimListTv;
    ...
    private void setupScreen() {
        ...
        notattend.setVisibility(View.GONE);
...
//                    }
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                mScannerView.resumeCameraPreview(VolunteerScanQRResolveActivity.this);
            }
        }, 1000);
    }
